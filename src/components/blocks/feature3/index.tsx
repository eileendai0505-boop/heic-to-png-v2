  ...
  return (
    <section className="py-16">
      <div className="container px-8">
        <div className="mb-16 max-w-xl px-8 lg:px-0 mx-auto text-center">
          {section.label && (
          ...
          <p className="mb-4 max-w-xl text-muted-foreground lg:max-w-none lg:text-lg mx-auto">
            {section.description}
          </p>
        </div>
        <div>
                  ...
                  >
                    <div className="flex gap-4 rounded-md px-8 py-4 text-left hover:bg-muted/50 lg:block lg:px-4">
                      <div className="flex flex-col items-center lg:contents">
                        <span className="flex size-14 shrink-0 items-center justify-center rounded-full border bg-background font-mono text-xs font-medium lg:size-16 lg:group-data-[state=active]:bg-primary lg:group-data-[state=active]:text-primary-foreground lg:group-data-[state=active]:ring-3 lg:group-data-[state=active]:ring-primary/40">
                          {item.icon ? (
                            <Icon name={item.icon} className="size-6 lg:size-8" />
                          ) : (
                            index + 1
                          )}
                        </span>
